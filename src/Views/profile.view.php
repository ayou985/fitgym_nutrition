...
<div class="container mt-5">
    ...
    <div class="text-center mb-4">
        <?php if (!empty($user->getProfileImage())): ?>
            <img src="<?= $baseUrl ?>/public/uploads/<?= htmlspecialchars($user->getProfileImage()) ?>" 
                 width="150" height="150" class="rounded-circle border" 
                 style="object-fit: cover;" alt="Photo de profil">
        <?php else: ?>
            <img src="<?= $baseUrl ?>/public/img/profile-user.png" 
                 width="150" height="150" class="rounded-circle" alt="Photo par défaut">
        <?php endif; ?>
    </div>

    <!-- Formulaire de mise à jour -->
    <div class="profile-container">
        <form action="<?= $baseUrl ?>/profile/update" method="POST" enctype="multipart/form-data" class="profile-form">
