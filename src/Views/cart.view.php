...
<div class="cart-container">
    <?php if (!empty($cartItems)) : ?>
        <form action="<?= $baseUrl ?>/cart/update" method="POST">
                    ...
                    ?>
                        <tr>
                            <td class="cart-product">
                                <img src="<?= $baseUrl ?>/public/uploads/<?= htmlspecialchars($product->getImage()) ?>" alt="<?= htmlspecialchars($product->getName()) ?>">
                            ...
                            <td>
                                <a href="<?= $baseUrl ?>/cart/remove?id=<?= $id ?>" class="btn-remove" onclick="return confirm('Supprimer ce produit du panier ?')">🗑</a>
                            </td>
                        </tr>
            ...
            <?php else: ?>
                <a href="<?= $baseUrl ?>/paiement" class="btn btn-link">Passer la commande</a>
            <?php endif; ?>
        </form>
    <?php else : ?>
