  ...
  <div id="carouselExampleIndicators" class="carousel slide">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="/public/img/carrousel1.png" class="d-block w-100 " alt="carrousel">
        </div>
        <div class="carousel-item">
          <img src="/public/img/carrousel2.jpg" class="d-block w-100" alt="carrousel">
        </div>
        <div class="carousel-item">
          <img src="/public/img/carrousel3.jpg" class="d-block w-100" alt="carrousel">
        </div>
      </div>
