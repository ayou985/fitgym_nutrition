...
class ProductController
{
    ...
    public function updateReviews()
    {
        ...
        if (!$userId || !$reviewId || !$newContent || !$newRating) {
            ...
            header("Location: " . \App\Utils\AbstractController::getBaseUrl() . "/produitdetail?id=" . $_POST['product_id']);
            exit;
        }
    ...
    public function submitReviews()
    {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            try {
                ...
                header("Location: " . \App\Utils\AbstractController::getBaseUrl() . "/produitdetail?id=" . $productId);
                exit;
            } catch (\Exception $e) {
    ...
    public function show()
    {
        ...
        if (isset($_SESSION['user'])) {
            ...
            $hasAlreadyReviewed = \App\Models\AllProduct::userHasReviewed($userId, $product_id);
        }
    ...
    public function deleteReviews()
    {
        ...
        if (!isset($_SESSION['user'])) {
            header("Location: " . \App\Utils\AbstractController::getBaseUrl() . "/login");
            exit;
        }
